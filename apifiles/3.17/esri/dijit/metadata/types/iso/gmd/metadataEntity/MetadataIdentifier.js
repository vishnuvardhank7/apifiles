...
define(
		...
		function(a, b, c, d, g, h, k, e, f) {
			...
			c("extend-esri")
					&& b
							.setObject(
									"dijit.metadata.types.iso.gmd.metadataEntity.MetadataIdentifier",
									a, f);
			return a
		});