...
define(
		...
		function(a, b, c, d, g, h, k, l, e, f) {
			...
			c("extend-esri")
					&& b
							.setObject(
									"dijit.metadata.types.iso.gmd.metadataEntity.MetadataOrganization",
									a, f);
			return a
		});